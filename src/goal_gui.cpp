...
struct GoalQuestionWindow : public Window {
	...
	void OnClick(Point pt, int widget, int click_count) override
	{
		switch (widget) {
			case WID_GQ_BUTTON_1:
				DoCommandP(0, this->window_number, this->button[0], 0, CMD_GOAL_QUESTION_ANSWER);
				delete this;
				break;

			case WID_GQ_BUTTON_2:
				DoCommandP(0, this->window_number, this->button[1], 0, CMD_GOAL_QUESTION_ANSWER);
				delete this;
				break;

			case WID_GQ_BUTTON_3:
				DoCommandP(0, this->window_number, this->button[2], 0, CMD_GOAL_QUESTION_ANSWER);
				delete this;
				break;
		}
	}
