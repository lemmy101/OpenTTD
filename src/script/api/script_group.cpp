...
{
	if (!ScriptObject::DoCommand(0, (::VehicleType)vehicle_type, parent_group_id, 0, CMD_CREATE_GROUP, nullptr, &ScriptInstance::DoCommandReturnGroupID)) return GROUP_INVALID;
...
/* static */ bool ScriptGroup::DeleteGroup(GroupID group_id)
{
	...
	return ScriptObject::DoCommand(0, group_id, 0, 0, CMD_DELETE_GROUP);
}
...
/* static */ bool ScriptGroup::SetName(GroupID group_id, Text *name)
{
	...
	return ScriptObject::DoCommand(0, group_id, 0, 0, CMD_ALTER_GROUP, text);
}
...
/* static */ bool ScriptGroup::SetParent(GroupID group_id, GroupID parent_group_id)
{
	...
	return ScriptObject::DoCommand(0, group_id | 1 << 16, parent_group_id, 0, CMD_ALTER_GROUP);
}
...
/* static */ bool ScriptGroup::EnableAutoReplaceProtection(GroupID group_id, bool enable)
{
	...
	return ScriptObject::DoCommand(0, group_id | GroupFlags::GF_REPLACE_PROTECTION, enable ? 1 : 0, 0, CMD_SET_GROUP_FLAG);
}
...
/* static */ bool ScriptGroup::MoveVehicle(GroupID group_id, VehicleID vehicle_id)
{
	...
	return ScriptObject::DoCommand(0, group_id, vehicle_id, 0, CMD_ADD_VEHICLE_GROUP);
}
...
/* static */ bool ScriptGroup::EnableWagonRemoval(bool enable_removal)
{
	...
	return ScriptObject::DoCommand(0, ::GetCompanySettingIndex("company.renew_keep_length"), enable_removal ? 1 : 0, 0, CMD_CHANGE_COMPANY_SETTING);
}
...
/* static */ bool ScriptGroup::SetAutoReplace(GroupID group_id, EngineID engine_id_old, EngineID engine_id_new)
{
	...
	return ScriptObject::DoCommand(0, group_id << 16, (engine_id_new << 16) | engine_id_old, 0, CMD_SET_AUTOREPLACE);
}
...
/* static */ bool ScriptGroup::StopAutoReplace(GroupID group_id, EngineID engine_id)
{
	...
	return ScriptObject::DoCommand(0, group_id << 16, (::INVALID_ENGINE << 16) | engine_id, 0, CMD_SET_AUTOREPLACE);
}
...
/* static */ bool ScriptGroup::SetPrimaryColour(GroupID group_id, ScriptCompany::Colours colour)
{
	...
	return ScriptObject::DoCommand(0, group_id, colour << 16, 0, CMD_SET_GROUP_LIVERY);
}
...
/* static */ bool ScriptGroup::SetSecondaryColour(GroupID group_id, ScriptCompany::Colours colour)
{
	...
	return ScriptObject::DoCommand(0, group_id, (1 << 8) | (colour << 16), 0, CMD_SET_GROUP_LIVERY);
}
