...
/* static */ bool ScriptMarine::BuildWaterDepot(TileIndex tile, TileIndex front)
{
	...
	return ScriptObject::DoCommand(tile, ::TileX(front) == ::TileX(tile), 0, 0, CMD_BUILD_SHIP_DEPOT);
}
...
/* static */ bool ScriptMarine::BuildDock(TileIndex tile, StationID station_id)
{
	...
	return ScriptObject::DoCommand(tile, p1, p2, 0, CMD_BUILD_DOCK);
}
...
/* static */ bool ScriptMarine::BuildBuoy(TileIndex tile)
{
	...
	return ScriptObject::DoCommand(tile, 0, 0, 0, CMD_BUILD_BUOY);
}
...
/* static */ bool ScriptMarine::BuildLock(TileIndex tile)
{
	...
	return ScriptObject::DoCommand(tile, 0, 0, 0, CMD_BUILD_LOCK);
}
...
/* static */ bool ScriptMarine::BuildCanal(TileIndex tile)
{
	...
	return ScriptObject::DoCommand(tile, tile, WATER_CLASS_CANAL, 0, CMD_BUILD_CANAL);
}
