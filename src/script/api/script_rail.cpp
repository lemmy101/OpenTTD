...
/* static */ bool ScriptRail::ConvertRailType(TileIndex start_tile, TileIndex end_tile, ScriptRail::RailType convert_to)
{
	...
	return ScriptObject::DoCommand(start_tile, end_tile, convert_to, 0, CMD_CONVERT_RAIL);
}
...
/* static */ bool ScriptRail::BuildRailDepot(TileIndex tile, TileIndex front)
{
	...
	return ScriptObject::DoCommand(tile, ScriptObject::GetRailType(), entrance_dir, 0, CMD_BUILD_TRAIN_DEPOT);
}
...
/* static */ bool ScriptRail::BuildRailStation(TileIndex tile, RailTrack direction, uint num_platforms, uint platform_length, StationID station_id)
{
	...
	return ScriptObject::DoCommand(tile, p1, (ScriptStation::IsValidStation(station_id) ? station_id : INVALID_STATION) << 16, 0, CMD_BUILD_RAIL_STATION);
}
...
/* static */ bool ScriptRail::BuildNewGRFRailStation(TileIndex tile, RailTrack direction, uint num_platforms, uint platform_length, StationID station_id, CargoID cargo_id, IndustryType source_industry, IndustryType goal_industry, int distance, bool source_station)
{
	...
	if (res != CALLBACK_FAILED) {
		...
		if (spec == nullptr) {
			...
			if (ScriptObject::DoCommand(tile, p1, p2 | spec->cls_id | index << 8, 0, CMD_BUILD_RAIL_STATION)) return true;
		}
	}

	return ScriptObject::DoCommand(tile, p1, p2, 0, CMD_BUILD_RAIL_STATION);
}
...
/* static */ bool ScriptRail::BuildRailWaypoint(TileIndex tile)
{
	...
	return ScriptObject::DoCommand(tile, GetCurrentRailType() | (GetRailTracks(tile) == RAILTRACK_NE_SW ? AXIS_X : AXIS_Y) << 6 | 1 << 8 | 1 << 16, STAT_CLASS_WAYP | INVALID_STATION << 16, 0, CMD_BUILD_RAIL_WAYPOINT);
}
...
/* static */ bool ScriptRail::RemoveRailWaypointTileRectangle(TileIndex tile, TileIndex tile2, bool keep_rail)
{
	...
	return ScriptObject::DoCommand(tile, tile2, keep_rail ? 1 : 0, 0, CMD_REMOVE_FROM_RAIL_WAYPOINT);
}
...
/* static */ bool ScriptRail::RemoveRailStationTileRectangle(TileIndex tile, TileIndex tile2, bool keep_rail)
{
	...
	return ScriptObject::DoCommand(tile, tile2, keep_rail ? 1 : 0, 0, CMD_REMOVE_FROM_RAIL_STATION);
}
...
/* static */ bool ScriptRail::BuildRailTrack(TileIndex tile, RailTrack rail_track)
{
	...
	return ScriptObject::DoCommand(tile, tile, GetCurrentRailType() | (FindFirstTrack((::TrackBits)rail_track) << 6), 0, CMD_BUILD_RAILROAD_TRACK);
}
...
/* static */ bool ScriptRail::RemoveRailTrack(TileIndex tile, RailTrack rail_track)
{
	...
	return ScriptObject::DoCommand(tile, tile, FindFirstTrack((::TrackBits)rail_track) << 6, 0, CMD_REMOVE_RAILROAD_TRACK);
}
...
/* static */ bool ScriptRail::BuildRail(TileIndex from, TileIndex tile, TileIndex to)
{
	...
	return ScriptObject::DoCommand(tile, to, p2, 0, CMD_BUILD_RAILROAD_TRACK);
}
...
/* static */ bool ScriptRail::RemoveRail(TileIndex from, TileIndex tile, TileIndex to)
{
	...
	return ScriptObject::DoCommand(tile, to, p2, 0, CMD_REMOVE_RAILROAD_TRACK);
}
...
/* static */ bool ScriptRail::BuildSignal(TileIndex tile, TileIndex front, SignalType signal)
{
	...
	return ScriptObject::DoCommand(tile, p1, 0, 0, CMD_BUILD_SIGNALS);
}
...
/* static */ bool ScriptRail::RemoveSignal(TileIndex tile, TileIndex front)
{
	...
	return ScriptObject::DoCommand(tile, track, 0, 0, CMD_REMOVE_SIGNALS);
}
