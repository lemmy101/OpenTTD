...
/* static */ bool ScriptRoad::ConvertRoadType(TileIndex start_tile, TileIndex end_tile, RoadType road_type)
{
	...
	return ScriptObject::DoCommand(start_tile, end_tile, (::RoadType)road_type, 0, CMD_CONVERT_ROAD);
}
...
/* static */ bool ScriptRoad::_BuildRoadInternal(TileIndex start, TileIndex end, bool one_way, bool full)
{
	...
	return ScriptObject::DoCommand(start, end, (::TileY(start) != ::TileY(end) ? 4 : 0) | (((start < end) == !full) ? 1 : 2) | (ScriptObject::GetRoadType() << 3) | ((one_way ? 1 : 0) << 10) | 1 << 11, 0, CMD_BUILD_LONG_ROAD);
}
...
/* static */ bool ScriptRoad::BuildRoadDepot(TileIndex tile, TileIndex front)
{
	...
	return ScriptObject::DoCommand(tile, entrance_dir | (ScriptObject::GetRoadType() << 2), 0, 0, CMD_BUILD_ROAD_DEPOT);
}
...
/* static */ bool ScriptRoad::_BuildRoadStationInternal(TileIndex tile, TileIndex front, RoadVehicleType road_veh_type, bool drive_through, StationID station_id)
{
	...
	return ScriptObject::DoCommand(tile, 1 | 1 << 8, p2, 0, CMD_BUILD_ROAD_STOP);
}
...
/* static */ bool ScriptRoad::RemoveRoad(TileIndex start, TileIndex end)
{
	...
	return ScriptObject::DoCommand(start, end, (::TileY(start) != ::TileY(end) ? 4 : 0) | (start < end ? 1 : 2) | (ScriptObject::GetRoadType() << 3), 0, CMD_REMOVE_LONG_ROAD);
}
...
/* static */ bool ScriptRoad::RemoveRoadFull(TileIndex start, TileIndex end)
{
	...
	return ScriptObject::DoCommand(start, end, (::TileY(start) != ::TileY(end) ? 4 : 0) | (start < end ? 2 : 1) | (ScriptObject::GetRoadType() << 3), 0, CMD_REMOVE_LONG_ROAD);
}
...
/* static */ bool ScriptRoad::RemoveRoadStation(TileIndex tile)
{
	...
	return ScriptObject::DoCommand(tile, 1 | 1 << 8, GetRoadStopType(tile), 0, CMD_REMOVE_ROAD_STOP);
}
